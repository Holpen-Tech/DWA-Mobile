const BASE_URL = 'http://192.168.2.206:3000/api'; // do make sure to include your IP address here
...
export const api = {
  jobs: {
    ...
    getCategoryDetail: async (categoryName) => {
      const response = await fetch(`${BASE_URL}/jobs/categories/${encodeURIComponent(categoryName)}`);
